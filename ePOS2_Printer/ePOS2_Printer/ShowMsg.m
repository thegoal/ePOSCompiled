...
+ (NSString *)getEposResultText:(int)resultCode
{
    ...
    switch (resultCode) {
        ...
        case EPOS2_CODE_ERR_DATA_CORRUPTED:
            ...
            break;
        case EPOS2_CODE_ERR_RECOVERY_FAILURE:
            result = @"EPOS2_CODE_ERR_RECOVERY_FAILURE";
            break;
        case EPOS2_CODE_ERR_JSON_FORMAT:
            result = @"EPOS2_CODE_ERR_JSON_FORMAT";
            break;
        case EPOS2_CODE_NO_PASSWORD:
            result = @"EPOS2_CODE_NO_PASSWORD";
            break;
        case EPOS2_CODE_ERR_INVALID_PASSWORD:
            result = @"EPOS2_CODE_ERR_INVALID_PASSWORD";
            break;
        default:
